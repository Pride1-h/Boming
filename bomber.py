...
W='\033[0m'
# The Credit For This Code Goes To SpeedX And All Other Contributors Listed At https://github.com/Thepride1-h/TBomb
...
def infinite(pn, dl, ch, max):
    ...
    while True:
        ...
        count_inf += 1
        # os.system('echo pride1-h>> count.xxx')
        time.sleep(float(dl))
        if (count_inf > maxlim):
            exit()
...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        try:
            ...
            if cc == "977":
                ...
                if success > 0:
                    ...
                    print(
                        '\t\tPlease Send A Mail To ggpride1-h29@gmail.com To Let Us Know...')
                    input('Press Enter To Exit...')
                    exit()
        ...
        print("              This Bomber Was Created By pride1-h !!                ")
        print("==================================================================")
        try:
...
if not cc.strip() == "977":
    if type == 1:
        print(
            '\t\tSorry But Call Bombing is Currently Supported Only For Nepali Numbers!!!!')
        print()
        input('Press Enter To Exit....')
        print('\n\n')
        banner()
...
if nm == 0:
    ...
    print("     Please keep your data connection active during bombing !!    ")
    print("==================================================================")
    print("             Target Number       : +977", pn)
    print("             Number of Threads   : ", nt)
    print("             Delay               : ", dl)
    print("==================================================================")
    print("              Use this for fun, not for revenge !!                ")
    print("              This Bomber Was Created By pride !!                ")
    print("==================================================================")
    print(W)
